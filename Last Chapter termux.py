...
d88P  Y88b 888                        888                    
888    888 888                        888                    
888        88888b.   8888b.  88888b.  888888 .d88b.  888d888 
888        888 "88b     "88b 888 "88b 888   d8P  Y8b 888P"   
888    888 888  888 .d888888 888  888 888   88888888 888     
Y88b  d88P 888  888 888  888 888 d88P Y88b. Y8b.     888     
 "Y8888P"  888  888 "Y888888 88888P"   "Y888 "Y8888  888     
                             888                             
                             888                             
                             888
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            Jaber Hossain
\033[1;37m Facebook:            Last Chapter
\033[1;37m Github  :                Jaber-gt
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://chat.whatsapp.com/DEb330GOkF30Hxt8SeoGs0')
        pass
    elif select =='F':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100091698847735')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
def p_dump():
    ...
    try:
        ...
        print(f"File Saved To  {filepath} ")
        print(47*'-')
        input("Press enter to back LAST Menu ")
        LAST(allkey)
    except Exception as e:
        print("Error : %s"%e) 
...
def cutter():
    ...
    sarfraz = input('Saving Put File Name:')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+last+' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File: " + last)
    print("New File Saved:" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back last Menu ")
    Lastallkey)       
